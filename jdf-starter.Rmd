...
```{r echo=FALSE}
df <- data.frame(
  Title = c("A book title", "Another book title", "And yet another title"),
  Description = c(
    "This is the first book. It's a great book with lots of interesting content. Definitely worth a read.",
    "This is the second book. It's not as great as the first one, but still worth checking out. It has some cool concepts.",
    "This is the third book. It's different from the first two, but that's not necessarily a bad thing. It has its own unique charm."
  ),
  Rating = c(4.5, 3.7, 4.0),
  stringsAsFactors = FALSE
)
kbl(df, booktabs = T, caption="Demo table") %>%
...
<!-- |---|:----------:|------------:|---------| -->
<!-- | test | test | test | test | -->
<!-- | Golden ratio | $\phi$  | 1\.618  | Number such that the ratio of test | -->
<!-- | Golden ratio         | test          | test          | Number such that the ratio of test to the number is equal to the ratio of its reciprocal to  | -->
